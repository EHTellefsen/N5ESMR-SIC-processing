"""
Tie point derivation via Radiative Transfer Model (RTM) for predicting daily Sea Ice Concentration (SIC) for the 
Nimbus 5 Electrically Scanning Microwave Radiometer (N5ESMR).
